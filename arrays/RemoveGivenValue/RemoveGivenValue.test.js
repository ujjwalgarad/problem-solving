const functionToTest = require('./RemoveGivenValue.js');

test('result', () => {
    expect(functionToTest([3,2,2,3], 3)).toStrictEqual([2,2]);
  });

test('result', () => {
expect(functionToTest([0,1,2,2,3,0,4,2], 2)).toStrictEqual([ 0, 1, 3, 0, 4 ]);
});
